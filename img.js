...
thumbnailDom.appendChild(thumbnailItemsDom[0]); /*initially first img is shown so its thumbnail image should be at last*/
...
let runNextAuto = setTimeout(() => {
    next.click(); /*automatically click next button after 7000ms*/
}, timeAutoNext);
